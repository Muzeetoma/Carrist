...
<a href="<?php echo e(route('register')); ?>" class="btn rounded-xlg ml-lg-3 bg-white shadow py-3 px-4"><span class="text-dark font-weight-bold"> Get started <span class="la la-arrow-right ml-3" style="font-size: larger;"></span></a>
<br><br><br>
<?php endif; ?>
...
<img src="<?php echo e(asset('/images/users/main_image.png')); ?>" class="img-fluid rounded-lg pr-lg-4 mr-lg-4" width="90%">
</div>
...
<a href="<?php echo e(route('category.carparts')); ?>"><h1 class="font-weight-bolder text-dark">Car parts</h1></a>
...
<div class="col-12 col-lg-3 mb-4">
  ...
  <div class="container py-4 px-3 b-3 bg-white rounded-lg">
    ...
    <img src="<?php echo e(asset('/images/carparts/'.$carpart->car_image)); ?>" style="border-radius:5px" class="img-fluid bg-light h-100" width="100%">
    </div>
   
    <div class="container mt-3 mb-2" style="text-align: left;">
    <h6 class="font-weight-bold text-secondary"><?php echo e($carpart->part_name); ?></h6>
    <span class="font-weight-bolder h5">
      <h5 class="text-dark font-weight-bold badge badge-warning p-2">N</span> <span><?php echo e($carpart->price); ?></span></h5>
...
<div class="row">
 ...
 <div class="col-12 col-md-6 col-lg-3 mb-4">
  <a href="/category/dealers/<?php echo e($user->d_id); ?>">
   ...
   <div style="width:100%;height:150px;" >
    <img src="<?php echo e(asset('/images/users/default.png')); ?>" style="border-radius:7px" class="img-fluid bg-light h-100" width="100%">
    </div>
     <?php else: ?>
     
        <br>
        <div style="width:100%;height:150px;" >
        <img src="<?php echo e(asset('/images/dealers/'.$user->image_path)); ?>" style="border-radius:7px" class="img-fluid bg-light h-100" width="100%">
        </div>
 ...
 <div class="container mt-3" style="text-align: left;">
  <h5 class="font-weight-bold text-dark text-center"><?php echo e($user->dealer_type); ?></h5>
  </div>
   ...
   <div style="width:100%;height:145px;">
    <img src="<?php echo e(asset('/images/users/default.png')); ?>" style="border-radius:7px" class="img-fluid bg-light h-100" width="100%">
     ...
     <?php else: ?>
        ...
        <br>
        <div style="width:100%;height:150px;">
          <img src="<?php echo e(asset('/images/mechs/'.$user->image_path)); ?>" style="border-radius:7px" class="img-fluid bg-light h-100" width="100%">
        </div>
     <?php endif; ?>
