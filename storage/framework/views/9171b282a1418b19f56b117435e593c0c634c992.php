...
<head>
    ...
    <title><?php echo e(config('app.name', 'QwikMech')); ?></title>
...
<body onload="showCoords(event)">
  ...
  <!-- Brand -->
  <a class="navbar-brand" href="/" id="nvb"><img src="<?php echo e(asset('/img/logo.png')); ?>" class="img-fluid pr-lg-4 ml-lg-4"/></a>
  ...
  <div class="collapse navbar-collapse ml-4 justify-content-end" id="collapsibleNavbar">
    <ul class="navbar-nav">
      ...
      <?php if($cart_num >= 1): ?>
     <form method="GET" action="<?php echo e(route('shopping.cart')); ?>" class="mr-5">
     <input type="hidden" name="user_id" value=""/>
      <?php echo e(csrf_field()); ?>

    <button type="submit" class="navbar-brand" style="background:transparent;border:1px solid transparent"><span class="la la-shopping-bag text-light" style="font-size:24px"></span><span class="small bg-danger rounded-circle px-1 py-0 text-light shadow"><?php echo e($cart_num); ?></span></button>
     </form>
     <?php endif; ?>
      <?php endif; ?>
       ...
       <li class="nav-item">
        <a class="nav-link" href="<?php echo e(route('category.carparts')); ?> "><span class="text-light " style="font-size:14px">AutoShop</span></a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="<?php echo e(route('category.mechanics')); ?> "><span class="text-light " style="font-size:14px">Mechs</span></a>
      </li>
     
       <li class="nav-item">
        <a class="nav-link" href="<?php echo e(route('category.dealers')); ?>"><span class="text-light " style="font-size:14px">Vends</span></a>
      </li>
    ...
    <?php if(auth()->guard()->guest()): ?>
       <?php if(Route::has('login')): ?>
        <li class="nav-item">
         <a class="nav-link" href="<?php echo e(route('login')); ?>"><span class="text-light " style="font-size:14px">Login</span></a>
        </li>
      <?php endif; ?>

       <?php if(Route::has('register')): ?>
         <li class="nav-item">
          <a class="nav-link" href="<?php echo e(route('register')); ?>"><span class="text-light font-weight-lighter bg-orange rounded py-1 px-2" style="font-size:12.5px">Signup</span></a>
         </li>
        <?php endif; ?>
          <?php else: ?>
                            <li class="nav-item dropdown">
                                <a id="navbarDropdown" class="nav-link dropdown-toggle" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" v-pre>
                                   <?php if(Auth::user()->profile_photo_path == ""): ?>
                                     ...
                                     <img src="<?php echo e(asset('/images/users/'.Auth::user()->profile_photo_path)); ?>" style="border:2px solid black" class="rounded-circle" height="25px" width="25px">
    ...
    <a id="" class="navbar-brand search-button"><span class="la la-search text-dark font-weight-bolder" style="font-size:23px"></span></a>
     <?php if(auth()->guard()->check()): ?>
     <?php if($cart_num >= 1): ?>
     <form method="GET" action="<?php echo e(route('shopping.cart')); ?>">
     <input type="hidden" name="user_id" value=""/>
      <?php echo e(csrf_field()); ?>
    ...
    </span><span class="small bg-primary rounded-circle px-1 py-0 text-light shadow"><?php echo e($cart_num); ?></span></button>
     </form>
     <?php endif; ?>
     <?php endif; ?>
    <a href="<?php echo e(route('user.edit')); ?>" class="navbar-brand"><span class="la la-user text-dark font-weight-bolder" style="font-size:23px"></span></a>
   ...
   <br><br>
    ...
    <div class="col-6 col-md-3 col-lg-3">
      <a class="navbar-brand " href="/"><img src="<?php echo e(asset('/img/logo.png')); ?>" width="30%" class="img-fluid pr-lg-4 ml-lg-4"/></a>
      <br>
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link" href="<?php echo e(route('category.mechanics')); ?> "><span class="text-light " style="font-size:14px">Mechanics</span></a>
      </li>
     
       <li class="nav-item">
        <a class="nav-link" href="<?php echo e(route('category.dealers')); ?>"><span class="text-light " style="font-size:14px">Dealers</span></a>
      </li>
    ...
    <div class="col-6 col-md-3 col-lg-3">
      ...
      <li class="nav-item">
        <a class="nav-link" href="<?php echo e(route('about')); ?> "><span class="text-light" style="font-size:14px">About</span></a>
      </li>
             </li>
    <?php if(auth()->guard()->guest()): ?>
       <?php if(Route::has('login')): ?>
       ...
       <?php if(Route::has('register')): ?>
        ...
        <?php endif; ?>
          <?php else: ?>
              ...
              <li class="nav-item">
           <a class="nav-link" href="<?php echo e(route('user.edit')); ?>"><span class="text-light " style="font-size:14px"> User profile</span>
             </a>
             </li>
   ...
   <ul class="navbar-nav">
    ...
    <div class="px-4">
    <span class="display-5">Hi, <?php if(auth()->guard()->check()): ?> <?php $arr = explode(' ',trim(Auth::user()->name)); echo htmlspecialchars($arr[0]); ?> <?php endif; ?>
            <?php if(auth()->guard()->guest()): ?> User <?php endif; ?>
...
<div class="tab-content">
  <div class="tab-pane container active px-5" id="home">
    ...
    <div class="col-2">
    <form method="POST" action="<?php echo e(route('carpart.details')); ?>" id="dealer_details_post">
          ...
          $(document).ready(function(){
            ...
            $('#car-search-bar').keyup(function(){
              ...
              if(query != ''){
                ...
                $.ajax({
                  url:"<?php echo e(route('autocomplete.carpart')); ?>",
                  method:"POST",
...
<?php /**PATH C:\Users\USER\carrier\resources\views/layouts/panel.blade.php ENDPATH**/ ?>