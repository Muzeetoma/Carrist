...
<ul class="navbar-nav  flex-column">
  <li class="nav-item">
    <a class="nav-link" href="<?php echo e(route('category.dealers')); ?>"><h5 class="text-dark font-weight-bolder">Categories</h5></a>
  </li>
   <?php $__currentLoopData = $dealer_types; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $types): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
  <li class="nav-item">
    <a class="nav-link" href="/category/dealers/<?php echo e($types->d_id); ?>"><span class="text-dark"><?php echo e($types->dealer_type); ?></span></a>
  </li>
  ...
  <div class="container border py-4 px-0 d-3" style="border-radius:20px">
    ...
    <img src="<?php echo e(asset('images/users/default.png')); ?>" class="box mx-auto rounded-lg img-fluid shadow-lg" width="60%">
     ...
     <?php else: ?>
        ...
        <nav> 
        <img src="<?php echo e(asset('images/users/'.$user->profile_photo_path)); ?>" class="box mx-auto rounded-lg img-fluid shadow-lg" width="60%">
        </nav>
     <?php endif; ?> <br>
...
<?php echo $__env->make('layouts.panel', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\USER\carrier\resources\views/category/dealers.blade.php ENDPATH**/ ?>