...
<div class="row">
  ...
  <div class="container">
    <center>
  <img src="{{ asset('images/users/_ceo.jpg') }}" class="rounded-circle" style="" height="150px" width="150px">
  <hr>
  ...
  <div class="container">
   <center>
  <img src="{{ asset('images/users/cto.jpg') }}" class="rounded-circle" style="" height="150px" width="150px">
  <hr>
