...
<head>
    ...
    <title>{{ config('app.name', 'QuickMech') }}</title>
 ...
 <script src="{{ asset('sb_admin/js/bootstrap.min.js') }}"></script>
 <script src="{{ asset('sb_admin/js/bootbox.min.js') }}"></script>
 ...
 <script src="{{ asset('sb_admin/js/jquery.js') }}"></script>
 <!--<script src="{{ asset('sb_admin/w3/w3.js') }}"></script>-->
    <!-- Fonts -->
...
<hr class="sidebar-divider">
     ...
     <li class="nav-item">
       ...
       <!-- Nav Item - Pages Collapse Menu -->
   <li class="nav-item">
     <a class="nav-link collapsed" href="{{ route('admin.carparts') }}">
      ...
      <!-- Nav Item - Pages Collapse Menu -->
      <li class="nav-item">
       <a class="nav-link collapsed" href="{{ route('admin.dealers') }}">
         ...
         <!-- Nav Item - Pages Collapse Menu -->
     <li class="nav-item">
       <a class="nav-link collapsed" href="{{ route('admin.dealer-types') }}">
      ...
      <li class="nav-item">
       <a class="nav-link collapsed" href="{{ route('admin.mechanic-types') }}">
       ...
       <li class="nav-item">
       <a class="nav-link collapsed" href="{{ route('admin.car-names') }}">
         <i class="fas fa-fw fa-car"></i>
         <span>Car Names</span>
       </a>
